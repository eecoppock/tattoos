...
$writedir = "/shared/tattoos/output-sp/"; 
...
while (<STIMFILE>) {
   ...
   $item{"$condition"}{"word_sp"} = "$word_sp";
...
if ($qnum > 0) {
 ...
 if ($qnum>$total) {
   ...
   print "<br><br><br><h1>Gracias!</h1>\n";
  
   print "<p>Completion URL: https://app.prolific.co/submissions/complete?cc=20BB95DE</p>"
   ...
   my $word_sp = $item{$condition}{"word_sp"};
   ...
   print "\n\n<form method=\"post\" action=\"display-question-sp.cgi\" autocomplete=\"off\">\n";
 
   print "<div align=center>";

   print "\n<p>Tiene un tatuaje en $word_sp.</p>\n";
