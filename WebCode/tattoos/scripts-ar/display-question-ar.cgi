...
open (STIMFILE,"$resourcedir" . "items-ar.csv") or die "Can't find items-ar.csv";
...
open (ORDERFILE, "$resourcedir" ."order-ar.txt");
...
if ($qnum > 0) {
 ...
 if ($qnum>$total) {
   ...
   print "<br><br><br><h1 style=\"text-align:right\">!شكرا لك
</h1>\n";
  
   print "<p style= \"text-align:right;\">:الرابط الاخير </p>";

   print "<p style= \"text-align:right;\"><a href=\"https://app.prolific.co/submissions/complete?cc=12923CCE\">https://app.prolific.co/submissions/complete?cc=12923CCE</a></p>";
   ...
   print "\n\n<form method=\"post\" action=\"display-question-ar.cgi\" autocomplete=\"off\">\n";
 
   print "<div align=center>";

   print "\n<p style= \"text-align:right;\"> لديها وشم على $word ها </p>\n";
